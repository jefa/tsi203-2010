	...
	public String adminRegistration(){
		...
		if(noMessages()) {
			...
			try {
				...
				if(servicesUser.existsAdminUser(username) || servicesUser.existsNormalUser(username)) {
				...
				servicesUser.createAdminUser(username, password, email, name);
				return "success";
