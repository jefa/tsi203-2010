...
public class SimpleWS1ServiceProxy implements edu.tsi.Practico.SimpleWS1Service_PortType {
  private String _endpoint = null;
  private edu.tsi.Practico.SimpleWS1Service_PortType simpleWS1Service_PortType = null;
  ...
  private void _initSimpleWS1ServiceProxy() {
    try {
      simpleWS1Service_PortType = (new edu.tsi.Practico.SimpleWS1Service_ServiceLocator()).getSimpleWS1ServicePort();
  ...
  public edu.tsi.Practico.SimpleWS1Service_PortType getSimpleWS1Service_PortType() {
    if (simpleWS1Service_PortType == null)
      _initSimpleWS1ServiceProxy();
