...
function addMarker(googlemap, lat, long) {
	...
	GEvent.addListener(marker, 'click', function() {
		marker.openInfoWindow('Matanga dijo la changa <br/>Si esta es la <font style="color:red;">  segunda</font> l�nea acepta html');
		});
...
function  initGeoCoder(map, hidden_lat, hidden_lng) {
	...
	if (GBrowserIsCompatible()) { 
	  ...
	  reasons[G_GEO_UNKNOWN_ADDRESS]    = "Direccion desconocida:  No se pudo encontrar una locaci�n geografica para la direcci�n ingresada.";
	  reasons[G_GEO_UNAVAILABLE_ADDRESS]= "Direccion no disponible:  La coordenadas para la direcci�n ingresada no pueden ser mostradas por condiciones legales.";
